...
#define BUILD_VARIANT_LABEL "e1q-S921USQS6DZF2-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "e1q-S921USQS6DZF2-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/e1qsqw/e1q:16/BP4A.251205.006/S921USQS6DZF2:user/release-keys"
#endif

#define KIMAGE_TEXT_BASE 0xffffffc008000000ULL
#define P0_PAGE_OFFSET 0xffffff8000000000ULL
#define P0_PHYS_OFFSET 0x80000000ULL
#if defined(APP_S921_STABLE_RACE) && APP_S921_STABLE_RACE
...
#define SLIDE_S921_SKB_DATA_DELTA (-0x1000LL)
#if defined(APP_S921_STABLE_RACE) && APP_S921_STABLE_RACE
...
#define SLIDE_S921_BANK_TASK_STRIDE 0xa00
#define SLIDE_S921_BANK_LOCK_OWNER_TASK 1
#define SLIDE_BANK_LOCK_OFF 0x5200
#define SLIDE_S921_BANK_LOCK_BASE 0x0ea0
#define SLIDE_S921_BANK_LOCK_SHIFT 10
#define SLIDE_S921_BANK_LOCK_BUCKET_MASK 0x1f
#define SLIDE_S921_BANK_LOCK_MAX_BUCKET 27
#define SLIDE_S921_TASK_OFF_CANDIDATES 0x1000, 0x4000
#define FOPS_S921_TASK_OFF_CANDIDATES 0x1000, 0x6000, 0x7000
...
#define SLIDE_S921_PROBE_PARENT_OFF 0x20
#define SLIDE_S921_PROBE_TARGET_IMAGE_OFF 0x023bb5b0ULL
#define P0_ORACLE_GATE_PAGE_OFF 0x1960
#define P0_ORACLE_GATE_OBJECT_INDEX 1
#define P0_ORACLE_PROBE_OFFSET 0x1f0000ULL
#define P0_FINGERPRINT_HEADER \
  "targets/e1q-S921USQS6DZF2/p0_fingerprint.h"

/* Bridge S921/E1Q macros to the shared C codebase S928 definitions */
#if defined(APP_S921_STABLE_RACE) && APP_S921_STABLE_RACE
#define APP_S928_STABLE_RACE 1
#define SLIDE_S928_SKB_DATA_DELTA SLIDE_S921_SKB_DATA_DELTA
#define SLIDE_S928_BANK_TASK_STRIDE SLIDE_S921_BANK_TASK_STRIDE
#define SLIDE_S928_BANK_LOCK_OWNER_TASK SLIDE_S921_BANK_LOCK_OWNER_TASK
#define SLIDE_S928_BANK_LOCK_BASE SLIDE_S921_BANK_LOCK_BASE
#define SLIDE_S928_BANK_LOCK_SHIFT SLIDE_S921_BANK_LOCK_SHIFT
#define SLIDE_S928_BANK_LOCK_BUCKET_MASK SLIDE_S921_BANK_LOCK_BUCKET_MASK
#define SLIDE_S928_BANK_LOCK_MAX_BUCKET SLIDE_S921_BANK_LOCK_MAX_BUCKET
#define SLIDE_S928_TASK_OFF_CANDIDATES SLIDE_S921_TASK_OFF_CANDIDATES
#define FOPS_S928_TASK_OFF_CANDIDATES FOPS_S921_TASK_OFF_CANDIDATES
#define SLIDE_S928_PROBE_PARENT_OFF SLIDE_S921_PROBE_PARENT_OFF
#define SLIDE_S928_PROBE_TARGET_IMAGE_OFF SLIDE_S921_PROBE_TARGET_IMAGE_OFF
#endif
